...
function queryPartnerships(db, req) {
...
function queryBowling(db, req) {
  ...
  return { player, spells, totals, years }
}

function queryFielding(db, req) {
  const playerId = Number(req.params.id)
