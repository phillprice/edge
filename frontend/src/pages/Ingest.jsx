...
function StaleFixturesPanel() {
  ...
  return (
    <div className="card" style={{ marginTop: '1.5rem' }}>
      ...
      <p style={{ fontSize: '0.88rem', color: 'var(--text2)', marginBottom: '1rem' }}>
        These pending or failed fixtures have been waiting more than 7 days, or failed all retries.
        If they are broken on play-cricket and will never ingest, mark them as ignored so they stop
