          ...
          >
                ...
                {mvp.map((p, i) => (
                  ...
                  >
                    ...
                    <td style={{ textAlign: 'right' }}>
                      {p.bowl > 0
                        ? +(p.bowl - p.bowlHaulBonus - p.bowlMaidenBonus).toFixed(1)
                        : '—'}
                    </td>
                    <td style={{ textAlign: 'right', color: 'var(--green)' }}>
            ...
            <div style={{ borderTop: '1px solid var(--border)', paddingTop: '0.4rem' }}>
              <div>
                ...
                {teamSR != null ? ` · team SR: ${teamSR}` : ''} · SR bonus: base pts × (yourSR ÷
                teamSR − 1) × {Math.round(srPct * 100)}% when faster than team
              </div>
              <div>
